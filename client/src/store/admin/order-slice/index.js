...
export const getAllOrdersForAdmin = createAsyncThunk(
    ...
    async() => {
        const response = await axios.post('http://localhost:5000/api/admin/orders/get');
...
export const getOrderDetailsForAdmin = createAsyncThunk(
    ...
    async(id) => {
        const response = await axios.post(`http://localhost:5000/api/admin/orders/details/${id}`);
        return response.data
    }
)
